...
def prove(seq: Sequent) -> Optional[Proof]:
    ...
    #for pf in p1.apply(seq):
    #    print(stringify(pf, 500, 80, False, None))
...
if __name__ == '__main__':
    ...
    for pf in tx.apply(seq):
        print(stringify(pf, 500, None, True, None))
    pass
